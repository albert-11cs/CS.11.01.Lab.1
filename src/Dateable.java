...
public class Dateable {
    ...
    public static void main(String[] args) {
        Scanner dateableScanner = new Scanner(System.in);
        System.out.println("Please enter your age:");
        int userAge = dateableScanner.nextInt();
        int dateableAge = userAge /2 + 7;
        System.out.println("If you're " + userAge + ", you should date someone who is at least " + dateableAge + ".");
